...
[Paper](https://arxiv.org/abs/2412.03603) · [PDF](https://arxiv.org/pdf/2412.03603) · [Issues](https://github.com/StaryMoon/HunyuanVideo-Unofficial/issues) · [Release](https://github.com/StaryMoon/HunyuanVideo-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="HunyuanVideo-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2412.03603). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Focus | This repository organizes a PyTorch implementation for HunyuanVideo: A Systematic Framework For Large Video Generative Models, focusing on large-scale text-to-video generation w... |
...
This repository organizes a PyTorch implementation for **HunyuanVideo: A Systematic Framework For Large Video Generative Models**, focusing on large-scale text-to-video generation with systematic open video foundation model design. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/HunyuanVideo-Unofficial.git
cd HunyuanVideo-Unofficial
python -m venv .venv
...
```python
import torch
from hunyuanvideo_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from hunyuanvideo_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2412.03603) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2412.03603) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2412.03603) |
...
```bibtex
@article{HunyuanVideo_2024,
  title   = {HunyuanVideo: A Systematic Framework For Large Video Generative Models},
  author  = {Weijie Kong and Qi Tian and Zijian Zhang and Rox Min and Zuozhuo Dai and Jin Zhou and Jiangfeng Xiong and Xin Li and others},
...
- Thanks to the authors of **HunyuanVideo: A Systematic Framework For Large Video Generative Models** for the original research.
...
pytorch, unofficial-implementation, reproduction, hunyuanvideo, video-generation, diffusion-transformer, text-to-video
